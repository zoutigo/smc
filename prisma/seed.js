...
const manualTranstockerDefaults = {
...
const baseStorageMeansSeedData = [
  {
    name: "Cold room A1",
...
const storageMeansSeedData = [...baseStorageMeansSeedData, ...manualTranstockerSeeds];
const flowSeedData = [
...
const buildSlug = (name, fallbackPrefix) => {
  const slug = (0, import_utils.slugifyValue)(name);
