...
export default function PackagingCard({ id, name, description, imageUrl, onEdit, onDelete }: PackagingCardProps) {
  ...
  return (
    <article className="flex h-full flex-col overflow-hidden rounded-[22px] border border-smc-border bg-smc-card shadow-soft">
      <div className="relative flex items-center justify-between gap-4 bg-gradient-to-r from-smc-primary/20 via-smc-info/10 to-smc-primary/5 px-5 py-4">
      ...
      <div data-testid="packaging-card-footer" className="relative flex items-center justify-between border-t border-smc-border/40 bg-gradient-to-r from-white via-smc-bg/80 to-white px-4 py-3">
        <span className="relative z-10 text-xs font-semibold tracking-[0.3em] text-smc-primary" data-testid="packaging-label">
          CATEGORY
        </span>
