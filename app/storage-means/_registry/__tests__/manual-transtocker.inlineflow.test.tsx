...
// Simplify flow validation to avoid Prisma enum import in tests
...
describe("ManualTranstockerForm inline user flow", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
