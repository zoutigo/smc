...
import { createPackagingMeanNoteAction, type NoteActionState } from "../actions";
...
export default function NotesSection({ packagingMeanId, slug, initialNotes }: NotesSectionProps) {
      ...
      {showForm ? (
        <form
          ...
          onSubmit={handleSubmit((values) => {
            ...
            fd.append("packagingMeanId", packagingMeanId);
            fd.append("slug", slug);
            fd.append("title", values.title);
            fd.append("content", values.content);
            startTransition(async () => {
              const result = await createPackagingMeanNoteAction(state, fd);
              setState(result);
